...
#define MACRO_ZONE_3 M_FLICKER
#define MACRO_ZONE_4 M_SINGLEFLASH
...
#define ANIMATION_ZONE_2 animation::FRONT_TO_BACK
#define ANIMATION_ZONE_3 animation::LEFT_TO_RIGHT
#define ANIMATION_ZONE_4 animation::RIGHT_TO_LEFT
#define ANIMATION_ZONE_5 animation::CHEVRON_BTF
#define ANIMATION_ZONE_6 animation::CHEVRON_FTB
